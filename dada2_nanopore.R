...
filF <- filterAndTrim(fnFs, filt=fnFs_filtered, compress = FALSE, maxEE = 10)
errF <- learnErrors(fnFs_filtered, errorEstimationFunction=PacBioErrfun, multithread=TRUE)
derepFs <- derepFastq(fnFs_filtered, verbose=TRUE)
