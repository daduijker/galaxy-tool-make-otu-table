...
def dada2_cluster(outputFolder):
    ...
    out, error = Popen(["Rscript", "/local_tools/naturalis/galaxy-tool-make-otu-table/dada2.R", outputFolder + "/combined_dada_filtered.fastq", outputFolder + "/otu_sequences.fa"], stdout=PIPE, stderr=PIPE).communicate()
